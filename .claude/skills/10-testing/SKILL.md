---
name: testing
description: Hệ thống test — tests/ (344 tests, 17 file). Cách chạy, mock Anki, viết test mới. Đọc TRƯỚC KHI báo xong bất kỳ task nào.
---
...
- Import add-on → Tools → Bento Forge V17.1 (Ctrl+Shift+I)
