...
- Bằng chứng baseline gần nhất: isolated suite `774 passed` sau Blueprint responsive polish; trước đó hai vòng `768 passed` sau lát cắt Workspace-Scoped Session Memory. Targeted UI/workspace/state/session/i18n của workbench mới `167 passed`. Chi tiết và điều kiện phát hành hiện hành ở [Personal Roadmap](../../work_items/PERSONAL_ROADMAP.md).
