...
| --- | --- | --- | --- | --- | --- |
| 18.3.0 | Chưa phát hành | Chờ CI | Chờ GUI smoke | — | Local 2026-08-24: Study Library/Scope/Card Drill đã triển khai; `178` targeted + hai vòng isolated `791 passed`, compile sạch. Còn smoke Reviewer trên profile backup trước phát hành. |
