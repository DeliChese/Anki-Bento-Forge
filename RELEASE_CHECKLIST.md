...
| --- | --- | --- | --- | --- | --- |
| 18.3.0 | Chưa phát hành | Chờ CI | Chờ GUI smoke | — | Local 2026-08-24: metadata/note-type migration đã đồng bộ; kế hoạch V18.3 chỉ là đề xuất, chưa thay đổi hành vi AI Study Session. |
