...
1. **Bug thuộc tầng nào?** AI / Batch / Audio / Worker / UI / Card / Utils / i18n → đọc skill tương ứng (INDEX trong `AGENTS.md`).
...
2. Tuân thủ QUY TẮC VÀNG trong [`AGENTS.md`](../../AGENTS.md) (không `aqt` top-level, không `print`, không bare `except`, thread-safe, i18n `t()`).
