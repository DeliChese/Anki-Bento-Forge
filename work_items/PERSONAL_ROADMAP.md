...
| --- | --- | --- |
| P0-01 — baseline test | 🟢 Local xanh | Compile toàn bộ Python và hai vòng isolated suite đều xanh `614 passed`; vẫn cần giữ gate này xanh trước merge/release. |
...
| P0-05 — AI Output Reliability | 🟡 Local implementation xanh | Batch/Chat vocab+grammar dùng chung parser/schema gate; grammar RAW vào Xưởng; AI config/history dùng profile path động; hai vòng `614 passed` xanh. Chủ dự án báo card output ổn định; còn smoke restart/profile backup và manual large-batch metrics trước 18.0.0. |
