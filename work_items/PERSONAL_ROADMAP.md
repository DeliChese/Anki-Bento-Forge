...
| --- | --- | --- |
| P0-01 — baseline test | 🟢 Local xanh | Compile Python/JavaScript xanh; full isolated suite gần nhất `820 passed, 28 skipped`. Vẫn cần giữ gate này xanh trước merge/release. |
...
| V18.2 — Contextual AI Workspaces | ⚫ Surface retired | Reviewer không còn Study Coach; Factory giữ luồng tạo thẻ trực tiếp Preview-first hiện hành. |
...
| Chinese Radical Mindmap | 🟡 Local xanh, chờ GUI smoke | AI sinh glyph+tên bộ thủ tối giản vào field additive (prompt/cache 44); Reviewer gắn lại click/hover khi lật mặt, có ba sơ đồ mỗi khung và kéo ngang. Full isolated `826 passed, 28 skipped`; còn smoke profile backup. |
