...
_TRANSLATIONS = {
    ...
    "study_reviewer_subtitle": {
        "vi": "Hiểu · nhớ lại · tiếp tục ôn tập.",
        "en": "Understand · retrieve · continue reviewing.",
    },
    "study_forge_title": {"vi": "Xưởng AI Forge", "en": "Forge AI Workshop"},
    "study_forge_subtitle": {
        "vi": "Phân tích nguồn và tạo học liệu có kiểm soát.",
        "en": "Analyze sources and build controlled learning material.",
    },
    ...
    "study_forge_mode_vocab": {"vi": "Tạo artifact từ vựng", "en": "Build Vocab Artifact"},
    "study_forge_mode_grammar": {"vi": "Tạo artifact ngữ pháp", "en": "Build Grammar Artifact"},
    ...
    "study_forge_route_strip": {"vi": "SOURCE  →  AI  →  ARTIFACT  →  XƯỞNG", "en": "SOURCE  →  AI  →  ARTIFACT  →  FACTORY"},
