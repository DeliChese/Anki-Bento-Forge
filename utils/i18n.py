...
_TRANSLATIONS = {
    ...
    "radical_show": {"vi": "🧩 Hiện bộ thủ", "en": "🧩 Show components"},
    "radical_hide": {"vi": "🧩 Ẩn bộ thủ", "en": "🧩 Hide components"},
    "radical_title": {"vi": "Sơ đồ cấu tạo chữ", "en": "Character component map"},
    "radical_close": {"vi": "Đóng", "en": "Close"},
    "radical_count_suffix": {"vi": "chữ", "en": "characters"},
    "radical_meaning_label": {"vi": "Nghĩa", "en": "Meaning"},
    "radical_role_label": {"vi": "Vai trò", "en": "Role"},
    "radical_character_label": {"vi": "Chữ", "en": "Character"},
    "radical_empty": {"vi": "Chữ đơn thể / chưa có thành phần", "en": "Single-form character / no components"},
    "radical_component": {"vi": "Thành phần", "en": "Component"},
    "radical_component_hint": {"vi": "Xem sơ đồ bộ thủ của", "en": "Open the component map for"},
    "card_upgrade_action": {"vi": "✨ Nâng cấp thẻ", "en": "✨ Upgrade card"},
    "card_upgrade_title": {"vi": "Nâng cấp chất lượng thẻ", "en": "Upgrade card quality"},
    "card_upgrade_desc": {"vi": "Tạo bản đề xuất theo chuẩn chất lượng hiện hành (revision {revision}). Chỉ các dòng bạn tích mới được ghi; SRS, lịch sử review và nội dung không tích giữ nguyên.", "en": "Generate a proposal using the current quality standard (revision {revision}). Only checked rows are saved; SRS, review history, and unchecked content remain unchanged."},
    "card_upgrade_result_title": {"vi": "Kết quả đề xuất của AI", "en": "AI proposal result"},
    "card_upgrade_result_empty": {"vi": "Kết quả AI sẽ xuất hiện tại đây. Bấm “Nhờ AI lập đề xuất” để bắt đầu; chưa có thay đổi nào được ghi vào thẻ.", "en": "The AI result will appear here. Select “Ask AI for proposal” to begin; no card changes have been saved."},
    "card_upgrade_result_ready": {"vi": "AI đã trả về {count} mục đề xuất. Tích các trường muốn giữ rồi bấm Áp dụng.", "en": "AI returned {count} proposed changes. Check the fields to keep, then select Apply."},
    "card_upgrade_open_error": {"vi": "Không thể mở Nâng cấp thẻ cho thẻ hiện tại. Hãy chuyển sang một thẻ Language cần nâng cấp rồi thử lại.", "en": "Card Upgrade could not open for the current card. Move to a Language card that needs an upgrade and try again."},
    "card_upgrade_field": {"vi": "Trường", "en": "Field"},
    "card_upgrade_before": {"vi": "Hiện có", "en": "Current"},
    "card_upgrade_after": {"vi": "Đề xuất mới", "en": "Proposed"},
    "card_upgrade_select_hint": {"vi": "Tích để áp dụng trường này", "en": "Check to apply this field"},
    "card_upgrade_audio": {"vi": "Tạo lại audio cho nội dung được cập nhật hoặc còn thiếu", "en": "Regenerate audio for updated or missing content"},
    "card_upgrade_generate": {"vi": "Nhờ AI lập đề xuất", "en": "Ask AI for proposal"},
    "card_upgrade_apply": {"vi": "Áp dụng mục đã chọn", "en": "Apply selected"},
    "card_upgrade_close": {"vi": "Đóng", "en": "Close"},
    "card_upgrade_generate_confirm": {"vi": "Gọi AI để tạo đề xuất nâng cấp cho đúng thẻ này? Không có dữ liệu nào được ghi cho tới khi bạn chọn và áp dụng.", "en": "Ask AI for an upgrade proposal for this card? Nothing is written until you select and apply changes."},
    "card_upgrade_generating": {"vi": "AI đang lập đề xuất nâng cấp…", "en": "AI is preparing the upgrade proposal…"},
    "card_upgrade_no_changes": {"vi": "AI không đề xuất thay đổi hiển thị được. Bạn có thể Áp dụng để đánh dấu thẻ đã đạt chuẩn hiện hành, hoặc đóng để giữ trạng thái cũ.", "en": "AI proposed no displayable changes. You may Apply to mark this card as meeting the current standard, or close to keep its old status."},
    "card_upgrade_select_required": {"vi": "Hãy tích ít nhất một trường muốn áp dụng.", "en": "Select at least one field to apply."},
    "card_upgrade_apply_confirm": {"vi": "Áp dụng các trường đã chọn? Bạn vẫn có thể dùng Undo của Anki ngay sau đó.", "en": "Apply the selected fields? You can still use Anki Undo immediately afterwards."},
    "card_upgrade_audio_loading": {"vi": "Đang tạo audio cho nội dung đã chọn…", "en": "Generating audio for selected content…"},
    "card_upgrade_audio_progress": {"vi": "Đang tạo audio {progress}", "en": "Generating audio {progress}"},
    "card_upgrade_saving": {"vi": "Đang ghi thẻ bằng thao tác có thể Undo…", "en": "Saving card in an undo-aware operation…"},
    "card_upgrade_saved": {"vi": "Đã nâng cấp thẻ. Bạn có thể Undo ngay trong Anki nếu cần.", "en": "Card upgraded. You can use Anki Undo immediately if needed."},
    "card_upgrade_identity_mismatch": {"vi": "AI trả về thẻ khác mục tiêu hiện tại nên hệ thống đã chặn không ghi dữ liệu.", "en": "AI returned a different target, so the update was blocked."},
    "card_upgrade_stale_note": {"vi": "Thẻ đã thay đổi trong lúc AI xử lý; đề xuất cũ không được ghi.", "en": "The card changed while AI was running; the old proposal was not written."},
    "card_upgrade_error": {"vi": "Không thể nâng cấp thẻ: {error}", "en": "Could not upgrade card: {error}"},
    "bulk_upgrade_action": {"vi": "🔄 Đồng bộ thẻ cũ", "en": "🔄 Sync existing cards"},
    "bulk_upgrade_action_tip": {"vi": "Cập nhật toàn bộ thẻ của ngôn ngữ và mode đang chọn theo template/chất lượng mới nhất", "en": "Update all cards in the selected language and mode to the latest template and quality standard"},
    "bulk_upgrade_title": {"vi": "Đồng bộ tất cả thẻ hiện có", "en": "Sync all existing cards"},
    "bulk_upgrade_desc": {"vi": "Template của Note Type hiện tại đã được đồng bộ một lần, không tốn AI. Các thẻ chưa đạt chuẩn nội dung sẽ được AI xử lý tuần tự; mỗi thẻ được kiểm tra lại định danh trước khi ghi và SRS không thay đổi.", "en": "The current Note Type template is synced once without AI. Cards behind the content standard are processed sequentially with AI; each identity is rechecked before saving and SRS is unchanged."},
    "bulk_upgrade_scanning": {"vi": "Đang quét các thẻ thuộc ngôn ngữ và mode hiện tại…", "en": "Scanning cards in the selected language and mode…"},
    "bulk_upgrade_summary": {"vi": "Tìm thấy {total} thẻ. {template} thẻ chỉ nhận template mới (không tốn AI); {ai} thẻ cần AI nâng cấp nội dung.", "en": "Found {total} cards. {template} only receive the new template (no AI); {ai} need AI content upgrades."},
    "bulk_upgrade_empty": {"vi": "Không tìm thấy thẻ nào thuộc Note Type hiện tại.", "en": "No cards were found for the current Note Type."},
    "bulk_upgrade_template_ready": {"vi": "Tất cả thẻ đã đạt chuẩn nội dung; template mới đã được đồng bộ, không cần gọi AI.", "en": "All cards already meet the content standard; the latest template has been synced and no AI call is needed."},
    "bulk_upgrade_ready": {"vi": "Sẵn sàng. Chỉ các thẻ cần nội dung mới mới tốn token AI.", "en": "Ready. Only cards requiring new content consume AI tokens."},
    "bulk_upgrade_start": {"vi": "Bắt đầu đồng bộ AI", "en": "Start AI sync"},
    "bulk_upgrade_cancel": {"vi": "Dừng sau thẻ hiện tại", "en": "Stop after current card"},
    "bulk_upgrade_confirm": {"vi": "Gọi AI tuần tự cho {count} thẻ cần nâng cấp nội dung? Lượt này có thể dùng token theo provider/model hiện tại. Những kết quả hợp lệ sẽ được ghi ngay, có thể Undo trong Anki; thẻ lỗi sẽ được bỏ qua và báo ở cuối.", "en": "Run AI sequentially for {count} cards that need content upgrades? This may consume tokens under the current provider/model. Valid results are saved immediately and can be undone in Anki; failed cards are skipped and reported at the end."},
    "bulk_upgrade_progress": {"vi": "Đang nâng cấp {current}/{total}: {target}", "en": "Upgrading {current}/{total}: {target}"},
    "bulk_upgrade_done": {"vi": "Hoàn tất: đã nâng cấp {updated}/{total} thẻ; bỏ qua {failed} thẻ lỗi hoặc đã thay đổi trong lúc xử lý.", "en": "Complete: upgraded {updated}/{total} cards; skipped {failed} cards that failed or changed during processing."},
    "bulk_upgrade_error": {"vi": "Không thể đồng bộ thẻ cũ: {error}", "en": "Could not sync existing cards: {error}"},
