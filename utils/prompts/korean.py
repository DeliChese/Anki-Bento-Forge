...
LUẬT:
1. Đủ 26 key; field tùy chọn không hữu ích = "". Ưu tiên 조사, 어미, speech level, honorific constraint như N께 N을/를 드리다, transitivity và verb–noun/adjective pairing; 묻다: 길을 묻다, KHÔNG 질문을 묻다.
...
RULES:
1. Fill all 26 keys; optional low-value fields = "". Prioritize 조사, 어미, speech level, honorific constraints, transitivity, and verb–noun/adjective pairing; 묻다: 길을 묻다, NEVER 질문을 묻다.
